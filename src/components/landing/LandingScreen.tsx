        ...
        <div className="relative z-10 mx-auto grid w-full max-w-5xl gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-white/65">
              ...
              du kanskje ikke bruker lenger. MVP-en kan skanne Gmail med read-only
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-5 shadow-2xl shadow-black/20">
            <div className="mb-4 flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-white">MVP/Beta</p>
                <p className="text-xs text-white/50">For offentlig demo og lokal testing</p>
              </div>
            ...
            <div className="flex flex-col gap-3">
              <MethodCard
                badge="Anbefalt"
                description="Logg inn med Vipps når nøkler er konfigurert."
                href="/login"
                icon="V"
                recommended
                title="Vipps Login"
              />
              <MethodCard
                description="Bruk magic-link hvis SMTP er konfigurert."
                href="/login"
                icon="@"
                title="E-post"
              />
              <MethodCard
                badge="Senere"
                description="BankID og nettbank blir del av en senere fase."
                disabled
                href="/connect"
                icon="ID"
                title="BankID og nettbank"
              />
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid w-full max-w-5xl gap-5 md:grid-cols-2">
          <div>
            ...
            <p className="mt-3 text-sm leading-6 text-white/60">
              Aboslutt er gratis i MVP/beta mens tjenesten testes. Betalte planer
              kommer senere når produktet er mer modent.
            </p>
          </div>
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-[#C8102E]/40 bg-[#C8102E]/15 p-5">
              <p className="text-sm font-semibold text-white/70">MVP/Beta</p>
              <p className="mt-3 text-3xl font-black">Gratis</p>
              <p className="mt-2 text-sm text-white/60">For demo, testing og tidlige brukere.</p>
            </div>
